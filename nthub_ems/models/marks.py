...
class Marks(models.Model):
    ...
    _name_uniq = models.Constraint(
        'unique(student_id,office_year,subject_id)',
    ...
    def create(self, vals_list):
        ...
        for rec in res:
            ...
            if rec.education_record_id:
                rec.student_id = rec.education_record_id.student_id
                rec.office_year = rec.education_record_id.yro
            else:
                edu_record = self.env['education.record'].sudo().search(
                    [('student_id', '=', rec.student_id.id), ('yro', '=', rec.office_year)])
                if edu_record:
                    rec.education_record_id = edu_record
                else:
